...
function update_config_install(){
	...
	if(!is_writable($config_name)) die("<h3><font color='red'>'config.php' is not writable. Please adjust the permission first!</font></h3>");
	...
	$config_contents=str_replace("_INSTALL_VWMLDBM_WWW_RT","/".basename(dirname(getcwd(),2))."/vwmldbm",$config_contents,$cnt); $tot_cnt+=$cnt;
