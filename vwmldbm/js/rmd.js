...
// SJH_MOD	
	...
	if((str.substring(0,8)=='vwmldbm_') || (str.substring(1,9)=='vwmldbm_') || (sub && sub[1]=='vwmldbm')){ // SJH_MOD	
		if(document.getElementById(tb1).style.display=='none') return;
	}
	if((str.substring(0,8)=='vwmldbm_') || (str.substring(1,9)=='vwmldbm_') || (sub2 && sub2[1]=='vwmldbm')){ // SJH_MOD	
